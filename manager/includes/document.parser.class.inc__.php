...
//                header('HTTP/1.0 404 Not Found');
   ...
   function evalSnippets($documentSource) {
    ...
    function prepareResponse() {
        ...
        if( ( ! $this->catalogFilterListX && ! $this->catalogPageNum && ! $this->catalogItemId ) || $this->documentIdentifier==$this->config['error_page'] ) $this->documentContent= $this->checkCache($this->documentIdentifier); //scorn
