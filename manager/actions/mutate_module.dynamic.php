...
<input type="hidden" name="mode" value="<?php echo $_GET['a']?>">
    ...
    <div id="actions">
          ...
          <?php } ?>
				  <option id="stay2" value="2" <?php echo $_REQUEST['stay']=='2' || $_REQUEST['stay']=='' ? ' selected="selected"' : ''?> ><?php echo $_lang['stay']?></option>
				  <option id="stay3" value="3"  <?php echo $_REQUEST['stay']=='3' ? ' selected="selected"' : ''?>  ><?php echo $_lang['close']?></option>
                </select>
              </li>
